    ...
    try:
        while True:
            ...
            # Prompt the user for a percentage.
                ...
                if perc_reduc > 100:
                    print(f"{perc_reduc} is too large.")
                    print("Sorry type other number between 0 to 100")
                    break
                elif perc_reduc <= 0:
                    print(f"{perc_reduc} is too small.")
        ...
        print(not_found_err)
        print("Please enter a correct file name or directory again")
        print("or")
        print("Check the file is in the directory and try again")
    except PermissionError as perm_err:
        print(perm_err)
        print("Sorry you don't have access to this file")
        print("Please use a correct user to open the file")
    except ValueError as val_err:
        print(val_err)
        print("Please enter a correct integer again")
