...
def print_death_age(people_dict):
    ...
    for person_key,people_features in people_dict.items():
        
        name = people_features[NAME_INDEX]
        death_year = people_features[DEATH_YEAR_INDEX]
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage_key,marriage_list in marriages_dict.items():
        ...
        # weadding year
        weadding_year = marriage_list[WEDDING_YEAR_INDEX]

        # age at weadding
        husband_age_weadding = weadding_year - husband_birth_year
        wife_age_weadding = weadding_year - wife_birth_year



        print("Marriages")
        print(f"{husband_name} {husband_age_weadding} > {weadding_year} < {wife_name} {wife_age_weadding}")
