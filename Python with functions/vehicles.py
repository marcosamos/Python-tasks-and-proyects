...
def main():
    ...
    if vin in vehicles:
        ...
        feature_list = vehicles[vin]
        MANUFACTURER_INDEX = feature_list[MANUFACTURER_INDEX]
        MODEL_INDEX = feature_list[MODEL_INDEX]
        COLOR_INDEX = feature_list[COLOR_INDEX]
        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        print(f"{MANUFACTURER_INDEX} {MODEL_INDEX} {COLOR_INDEX}")
